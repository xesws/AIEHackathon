...
def sample_format(sample_list):
    ...
    for x in sample_list:
        ...
        if list(list1) != ["pre", "case_id", "requested_rewrite", "post"]:
            tag = False
            break
        elif list(list2) != ["rewrite_ans", "rephrase_ans", "locality_ans", "portability_ans"] and list(list2) != [
            "rewrite_ans",
            "rephrase_ans",
            "portability_ans",
        ]:
            ...
            tag = False
            break
        elif list(list4) != ["rewrite_ans", "rephrase_ans", "locality_ans", "portability_ans", "fluency"] and list(
            list4
        ) != ["rewrite_ans", "rephrase_ans", "portability_ans", "fluency"]:
            tag = False
            break
    return tag
