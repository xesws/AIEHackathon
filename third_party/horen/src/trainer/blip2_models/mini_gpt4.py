...
class MiniGPT4(Blip2Base):
    ...
    def stack_with_padding(self, tensor_list, padding_value=-100):
        ...
        for t in processed_tensors:
            if t.size(0) < max_x:
                ...
                pad = torch.full(pad_shape, fill_value=padding_value, dtype=dtype, device=device)
    ...
    def forward(self, samples):
        ...
        # return {"loss": loss}
        return MiniGPTOutput(loss=loss, logits=outputs.logits, labels=targets, attention_mask=attention_mask)
