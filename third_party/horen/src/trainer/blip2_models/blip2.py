...
class Blip2Base(BaseModel):
    ...
    @classmethod
    def init_Qformer(
        cls, num_query_token, vision_width, qformer_name_or_path="bert-base-uncased", cross_attention_freq=2
    ):
    ...
    @classmethod
    def init_vision_encoder(cls, model_name, img_size, drop_path_rate, use_grad_checkpoint, precision, state_dict_file):
        assert model_name in [
            "eva_clip_g",
            "clip_L",
        ], "vit model must be eva_clip_g or clip_L"
        if model_name == "eva_clip_g":
            visual_encoder = create_eva_vit_g(img_size, drop_path_rate, use_grad_checkpoint, precision, state_dict_file)
