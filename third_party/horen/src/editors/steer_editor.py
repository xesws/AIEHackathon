...
class SteerEditor:
    ...
    def generate(self, input_text: str = None, input_image: str = None, temperature: float = None, **model_kwargs):
        ...
        # base decoding methods
            ...
            outputs = self.model.generate(**inputs, do_sample=True if temperature > 0 else False, **model_kwargs)
