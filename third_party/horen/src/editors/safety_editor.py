        ...
        for j in range(len(requests)):
            ...
            for layer_index in range(1, len(hidden_states)):
                euclidean_distance = torch.dist(
                    hidden_states[layer_index][j * 2], hidden_states[layer_index][j * 2 + 1], p=2
                )
        ...
        **kwargs,
        ...
        if "requests" in kwargs.keys():
            ...
            requests = self._prepare_requests(
                prompts, target_new, ground_truth, general_prompt, locality_inputs, **kwargs
            )
    ...
    def _prepare_requests(
        ...
        **kwargs,
        ...
        if general_prompt is None:
            requests = [
                {"prompt": prompt, "target_new": target_new_, "ground_truth": ground_truth_, "locality": {}}
