...
from ...trainer.algs.malmen.util import get_module, get_shape, TracerDict, cross_entropy, kl_div, succ_ratios
    ...
    def predict_param_shifts(self, module_kv_map) -> Dict[str, torch.FloatTensor]:
        ...
        for module_idx, module_name in enumerate(self.config.inner_params):
            ...
            hidden_states = torch.cat(
                [module_kv_map[module_idx][idx]["keys"] for idx in range(len(module_kv_map[module_idx]))]
            )
