...
def compute_v(
    ...
    rewriting_prompts, kl_prompts = [
        context.format(request["prompt"]) + tok.decode(target_ids[:-1]) for context in context_templates
    ], ["{} is a"]
    ...
    vanilla_input_prompts = [
        context.format(request["prompt"]).format(request["subject"]) for context in context_templates
...
def find_fact_lookup_idx(
    prompt: str, subject: str, tok: AutoTokenizer, fact_token_strategy: str, verbose=True, input_prompt=None
) -> int:
    """
