...
class IKEHyperParams(HyperParams):
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and config["alg_name"] == "IKE") or print(
            f"IKEHyperParams can not load from {hparams_name_or_path}, " f'alg_name is {config["alg_name"]} '
        )
        return cls(**config)
...
class IKEMultimodalHyperParams(HyperParams):
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and config["alg_name"] == "IKE") or print(
            f"IKEMultimodalHyperParams can not load from {hparams_name_or_path}, " f'alg_name is {config["alg_name"]} '
        )
        return cls(**config)
