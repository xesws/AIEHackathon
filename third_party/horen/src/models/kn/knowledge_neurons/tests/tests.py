...
def test_bert_base():
    ...
    results_dict, unpatch_fn = kn.erase_knowledge(TEXT, refined_neurons, target=GROUND_TRUTH, erase_value="unk")
...
def test_bert_multilingual():
    ...
    print("\nSuppressing refined neurons: \n")
    results_dict, unpatch_fn = kn_ml.suppress_knowledge(TEXT, GROUND_TRUTH, refined_neurons)
    ...
    results_dict, unpatch_fn = kn_ml.suppress_knowledge(TEXT, GROUND_TRUTH, random_neurons)
    ...
    results_dict, unpatch_fn = kn_ml.suppress_knowledge(TEXT, GROUND_TRUTH, refined_neurons_fr)

    print("\nEnhancing refined neurons: \n")
    results_dict, unpatch_fn = kn_ml.enhance_knowledge(TEXT, GROUND_TRUTH, refined_neurons)

    print("\nEnhancing random neurons: \n")
    results_dict, unpatch_fn = kn_ml.enhance_knowledge(TEXT, GROUND_TRUTH, random_neurons)
